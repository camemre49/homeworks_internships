...
public:
    ...
    Matrix4 calculateViewTransformationMatrix();
    Matrix4 calculateOrthographicViewTransformationMatrix();
    Matrix4 calculatePerspectiveViewTransformationMatrix();
    Matrix4 calculateCameraTransformationMatrix();
    Matrix4 perspective2Orthographic();
};
